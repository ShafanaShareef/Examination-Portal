			...
			if (mysql_num_rows($result1) > 0) 
				{
					...
					echo	"<form action='editsort3.php' method='POST' align='center'>";
					echo	"<table  width='100%' height='100%' border='1'   >";

		
		
					echo	"<tr ><td >Que No:<input type='text' name='no1' size='4' value='01' ></td><td >Enter the Question:<input type='text' name='qs1' size='130' ></td></tr>";
					//echo	"<td>Answer 01:<input type='text' name='ans11' size='35'></td><td>Answer 02:<input type='text' name='ans12' size='35'></td><td>Answer 03:<input type='text' name='ans13' size='35'></td><td>Answer 04:<input type='text' name='ans14' size='35'></td></tr>	";	
						...
						echo	"<tr><td >Que No:<input type='text' name='no2' size='4' value='02'></td><td>Enter the Question:<input type='text' name='qs2' size='130'></td></tr>";
					...
					echo	"<tr><td >Que No:<input type='text' name='no3' size='4' value='03'></td><td >Enter the Question:<input type='text' name='qs3' size='130'></td></tr>";
